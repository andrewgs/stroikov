    ...
    <div id="main-wrap">
		...
		<div id="content">
			<div class="container_12">
				...
				<?=form_open_multipart('admin/newsinsert',array('id'=>'formnews'));?>
						<strong>Дата новости</strong>
						<div class="dd">
	<?=form_input(array('name'=>'date','id'=>'datepicker','class'=>'inpval','readonly'=>'readonly','style'=>'width:100px;','value'=>set_value('date')));?>
						</div>
						<hr size="2"/>
						<div>
						...
						<div class="dd">
						<?=form_textarea(array('name'=>'newsheader','id'=>'newsheader','class'=>'inpval','value'=>set_value('newsheader')));?>
						</div>
						<strong>Текст новости</strong>
						<div class="dd">
						<?=form_textarea(array('name'=>'newsbody','id'=>'newsbody','class'=>'inpval','value'=>set_value('newsbody')));?>
						</div>
