<head>
	...
	<link rel="stylesheet" href="<?=$baseurl;?>js/redactor/css/redactor.css" type="text/css" />
	<link rel="stylesheet" href="<?=$baseurl;?>css/datepicker/jquery.ui.all.css" type="text/css" media="screen"/>
	<!--[if lt IE 7.]>
