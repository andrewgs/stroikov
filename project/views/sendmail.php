		...
		<div id="content">
			<div class="container_12">
				<div class="grid_4 omega admin-menu">
					<a href="<?php echo $data1['baseurl'].'contacts'; ?>">&laquo; Вернуться назад</a>
				</div>
				<div class="clear"></div>			
				<div class="grid_8">
					<h3 class="mb20">Сообщение отправлено</h3>
					<div class="plain-text"> Ваше сообщение отправлено. Ожидайте и мы обязательно Вам ответим! </div>				
				</div>
				<div class="visit-card grid_4">
					...
					344006<br/>
					г.Ростов-на-Дону<br/>
					ул.Социалистическая, 154<br/><br/>  
					Тел/факс: (863) 263-31-99, 240-50-98<br/>
					E-mail: <a href="mailto:info@sk-stroikov.ru">info@sk-stroikov.ru</a>
					</p>
				</div>
				<div class="clear"></div>					
			</div>
